    ...
    app.View = class {
        constructor() {
            this._elm = {
                ...
                inputField: this.getElement("input"),
                allTasksList: this.getElement('allTasksList'),
                inProgressList: this.getElement('inProgressList'),
                completedList: this.getElement('completedList'),
                addBtn: this.getElement('addBtn')
            }
        }
    
        handleInput(v) {
            if (!v) return this._elm.inputField.value;
            return this._elm.inputField.value = v;
        }
        ...
        createTodoItem(item) {
            ...
            itemIcon.src = this._elm.itemIconSrc;
            completeIcon.src = this._elm.completedIconSrc;
            ...
            taskTitleWrapper.appendChild(completeIcon);
        ...
        initializeLists() {
            this._elm.allTasksList.innerHTML = "";
            this._elm.inProgressList.innerHTML = "";
            this._elm.completedList.innerHTML = "";
        }
    
        emptyLists() {
            this._elm.allTasksList.innerHTML = "<li class='default-item'>Nothing to do.</li>";
            this._elm.inProgressList.innerHTML = "<li class='default-item'>Nothing in progress.</li>";
            this._elm.completedList.innerHTML = "<li class='default-item'>Nothing completed.</li>";
        ...
        displayLists(items) {
            ...
            this._elm.allTasksList.innerHTML = "";
            items.forEach(item => {
                const listItem = this.createTodoItem(item);
                this._elm.allTasksList.appendChild(listItem);
            })
        }
    
        bindAddItem(handler) {
            this._elm.addBtn.addEventListener('click', () => {
                if (this.handleInput()) {
