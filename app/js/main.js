...
class View {
    ...
    displayTasks(tasks) {
        ...
        tasks.forEach(task => {
            ...
            itemIcon.src = this.itemIconSrc;
            completeIcon.src = this.completedIconSrc;
            ...
            this.allTasksList.appendChild(listItem);
        })
